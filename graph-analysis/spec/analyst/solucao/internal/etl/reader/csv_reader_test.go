...
func TestReadCountries(t *testing.T) {
	...
	ds := &source.CSVSource{Path: file}

	result := reader.ReadCountries(ds)
...
func TestReadCovidCases(t *testing.T) {
	...
	cases := reader.ReadCovidCases(ds)
...
func TestReadVaccinations(t *testing.T) {
	...
	records := reader.ReadVaccinations(ds)
...
func TestReadVaccineApprovals(t *testing.T) {
	...
	approvals := reader.ReadVaccineApprovals(ds)
...
func TestReadCountryVaccines(t *testing.T) {
	...
	cv := reader.ReadCountryVaccines(ds)
	require.Len(t, cv, 1)
